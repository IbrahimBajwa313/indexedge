...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow pt-32 pb-20 px-4 bg-secondary">
        <section className="container mx-auto max-w-5xl space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[{
              ...
              <Card key={i} className="border-border shadow-md hover:shadow-lg transition">
          ...
          <div className="space-y-16">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-foreground mb-6">Why Dubai?</h2>
              <div className="grid md:grid-cols-3 gap-6">
                {[{
                  ...
                  <Card key={i} className="border-border shadow-md text-center">
                    <CardContent className="p-6">
                      <div className="bg-emerald-100 p-3 rounded-full text-emerald-600 inline-block mb-4">
                        <item.icon className="h-6 w-6" />
                      </div>
            ...
            <div className="text-center">
              <h2 className="text-3xl font-bold text-foreground mb-6">Why Choose IndexEdge?</h2>
